...
void EatonDriver::decodeReport(USBHostUPS* host, uint8_t report_id, uint8_t report_type, const uint8_t *data, size_t length, UPSData& ups_data) {
    ...
    static const Mapping mappings[] = {
        { "UPS.PowerSummary.PresentStatus.ACPresent", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.acPresent = v != 0; } },
        { "UPS.PowerSummary.PresentStatus.Discharging", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.discharging = v != 0; } },
        { "UPS.PowerSummary.PresentStatus.Charging", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.charging = v != 0; } },
        { "UPS.PowerSummary.PresentStatus.BelowRemainingCapacityLimit", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.belowRemainingCapacityLimit = v != 0; } },
        { "UPS.PowerSummary.PresentStatus.NeedReplacement", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.needReplacement = v != 0; } },
        { "UPS.PowerSummary.PresentStatus.Overload", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.overload = v != 0; } },
        { "UPS.PowerSummary.PresentStatus.ShutdownImminent", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.shutdownImminent = v != 0; } },
        { "UPS.PowerSummary.PresentStatus.CommunicationLost", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.communicationLost = v != 0; } },
        { "UPS.PowerSummary.PresentStatus.Good", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.good = v != 0; } },
        { "UPS.PowerSummary.PresentStatus.InternalFailure", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.internalFailure = v != 0; } },
        
        { "UPS.OutletSystem.Outlet.PresentStatus.SwitchOn/Off", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.outlet1Switch = v != 0; d.outlet2Switch = v != 0; } },
        ...
        { "UPS.PowerConverter.Output.Voltage", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.outputVoltage = v; } },
        
        { "UPS.PowerSummary.Voltage", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.batteryVoltage = v; } },
        { "UPS.BatterySystem.Voltage", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.batteryVoltage = v; } },
        { "UPS.PowerSummary.RemainingCapacity", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.remainingCapacity = v > 100 ? 100 : (uint8_t)v; } },
        { "UPS.PowerSummary.RemainingCapacityLimit", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.remainingCapacityLimit = (uint8_t)v; } },
        { "UPS.PowerSummary.RunTimeToEmpty", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.runTimeToEmpty = (uint32_t)v; } },
        
        { "UPS.BatterySystem.Battery.DesignCapacity", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.designCapacity = (uint8_t)(v / 3600.0); } },
        
        { "UPS.Flow.ConfigApparentPower", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.configApparentPower = (uint16_t)v; } },
        { "UPS.Flow.ConfigActivePower", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.configActivePower = (uint16_t)v; } },
        { "UPS.Flow.ConfigFrequency", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.configFrequency = (uint8_t)v; d.outputFrequencyNominal = (uint16_t)v; } },
        { "UPS.Flow.ConfigVoltage", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.configVoltage = (uint16_t)v; d.outputVoltageNominal = (uint16_t)v; } },
        { "UPS.PowerConverter.Output.ConfigVoltage", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.outputVoltageNominal = (uint16_t)v; } },
        
        { "UPS.PowerConverter.Output.HighVoltageTransfer", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.highVoltageTransfer = (uint16_t)v; } },
        { "UPS.PowerConverter.Output.LowVoltageTransfer", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.lowVoltageTransfer = (uint16_t)v; } },
        ...
        { "UPS.PowerSummary.DelayBeforeShutdown", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.delayShutdown = (int32_t)v; d.timerShutdown = (int32_t)v; } },
        { "UPS.PowerSummary.DelayBeforeStartup", [](EatonDriver*, UPSData& d, double v, const HIDUsageDef*) { d.delayStart = (int32_t)v; d.timerStart = (int32_t)v; } },
